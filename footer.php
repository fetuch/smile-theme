...
<footer class="bg-primary" aria-labelledby="footer">
	...
	<div class="mx-auto max-w-6xl py-8 px-4 lg:px-8">
		<div class="space-y-8 sm:space-y-0 sm:grid sm:grid-cols-2 gap-10 lg:grid-cols-4">
			<div>
				<p class="mt-4 text-sm leading-6 text-white">
					Lorem, ipsum dolor sit amet consectetur adipisicing elit. Odit nobis voluptate sequi ullam, inventore provident beatae cumque modi hic aperiam aut iure dignissimos earum cum, consequatur fugit, deserunt repellendus reiciendis?
				</p>
			</div>
			...
			<div class="space-y-8">
				...
				<ul role="list" class="mt-6 space-y-4">
					...
					<li>
						<span class="text-sm text-white">Tel: 666 666 666</span>
					</li>
					<li>
